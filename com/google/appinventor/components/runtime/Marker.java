...
public class Marker extends MapFeatureBaseWithFill implements MapMarker {
    ...
    private static final MapFeatureVisitor<Double> bearingComputation = new C04092();
    private static final MapFeatureVisitor<Double> distanceComputation = new C04081();
    ...
    static class C04081 implements MapFeatureVisitor<Double> {
        C04081() {
        }
    ...
    static class C04092 implements MapFeatureVisitor<Double> {
        C04092() {
        }
