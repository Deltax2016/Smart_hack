...
public final class GeoJSONUtil {
    ...
    static class C04181 implements PropertyApplication {
        C04181() {
        }
    ...
    static class C04192 implements PropertyApplication {
        C04192() {
        }
    ...
    static class C04203 implements PropertyApplication {
        C04203() {
        }
    ...
    static class C04214 implements PropertyApplication {
        C04214() {
        }
    ...
    static class C04225 implements PropertyApplication {
        C04225() {
        }
    ...
    static class C04236 implements PropertyApplication {
        C04236() {
        }
    ...
    static class C04247 implements PropertyApplication {
        C04247() {
        }
    ...
    static class C04258 implements PropertyApplication {
        C04258() {
        }
    ...
    static class C04269 implements PropertyApplication {
        C04269() {
        }
    ...
    static {
        ...
        SUPPORTED_PROPERTIES.put(PROPERTY_ANCHOR_HORIZONTAL.toLowerCase(), new C04181());
        SUPPORTED_PROPERTIES.put(PROPERTY_ANCHOR_VERTICAL.toLowerCase(), new C04192());
        SUPPORTED_PROPERTIES.put(PROPERTY_DESCRIPTION, new C04203());
        SUPPORTED_PROPERTIES.put(PROPERTY_DRAGGABLE, new C04214());
        SUPPORTED_PROPERTIES.put(PROPERTY_FILL, new C04225());
        SUPPORTED_PROPERTIES.put(PROPERTY_HEIGHT, new C04236());
        SUPPORTED_PROPERTIES.put(PROPERTY_IMAGE, new C04247());
        SUPPORTED_PROPERTIES.put(PROPERTY_INFOBOX, new C04258());
        SUPPORTED_PROPERTIES.put(PROPERTY_STROKE, new C04269());
