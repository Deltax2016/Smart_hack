...
public class Voting extends AndroidNonvisibleComponent implements Component {
    ...
    class C04162 implements AsyncCallbackPair<JSONObject> {
    ...
    class C04174 implements AsyncCallbackPair<String> {
    ...
    private void postRequestBallot() {
        WebServiceUtil.getInstance().postCommandReturningObject(this.serviceURL, REQUESTBALLOT_COMMAND, null, new C04162());
    }
    ...
    private void postSendBallot(String userChoice, String userId) {
        AsyncCallbackPair<String> myCallback = new C04174();
