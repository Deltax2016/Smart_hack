...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03851());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C03851 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03851() {
            }
