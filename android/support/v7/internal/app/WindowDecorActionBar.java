...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04361();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04372();
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03943();

    class C03943 implements ViewPropertyAnimatorUpdateListener {
        C03943() {
        }
    ...
    class C04372 extends ViewPropertyAnimatorListenerAdapter {
        C04372() {
        }
