...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C04412 extends ViewPropertyAnimatorListenerAdapter {
    ...
    class C04423 extends ViewPropertyAnimatorListenerAdapter {
        C04423() {
        }
    ...
    public void animateToVisibility(int visibility) {
        if (visibility == 8) {
            ViewCompat.animate(this.mToolbar).alpha(0.0f).setListener(new C04412());
        } else if (visibility == 0) {
            ViewCompat.animate(this.mToolbar).alpha(1.0f).setListener(new C04423());
        }
    }
